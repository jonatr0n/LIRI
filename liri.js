...
function bandsInTown() {
    ...
    request(queryUrl, function (error, response, body) {
        if (!error && response.statusCode === 200) {
            ...
            var queryUrlResults =
                "Venue: " + myBandData[0].venue.name + "\n" +
                "City: " + myBandData[0].venue.city + "\n" +
                "Date / Time: " + myBandData[0].datetime;
            console.log(" ");
            console.log("-----------START-------------");
            console.log(queryUrlResults)
            console.log("------------END-------------- ");
